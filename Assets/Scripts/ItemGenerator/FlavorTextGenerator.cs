...
public class FlavorTextGenerator {
    private Dictionary<EEquipmentType, string> flavorText = new Dictionary<EEquipmentType, string>() {
        ...
        { EEquipmentType.MACE, "Big stick with pointy bits, perfect against armor" },
        ...
        { EEquipmentType.GREAT_SWORD, "A two handed blade that is comicly big" },
        ...
        { EEquipmentType.ARMOR, "Protect thyne knees" },
