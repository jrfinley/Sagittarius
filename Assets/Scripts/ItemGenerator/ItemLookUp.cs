...
namespace ItemGeneratorHelpers {
    public class ItemLookUp {
        ...
        { EEquipmentType.AXE, new Item(
                ...
                new ItemTypes(EItemType.HELD, EEquipmentType.AXE, EItemEquipSlot.ONE_HAND, EItemWeightClass.MEDIUM, EWeaponDamageType.SLASHING, EWeaponRange.MEDIUM, EItemRarity.COMMON)
            ) },
        { EEquipmentType.MACE, new Item(
                "Mace", "Big stick with pointy bits, perfect against armor", "Mace",
                new ItemStats(3, 0, 3, 3, 0, 0, 3, 10, 5, 5),
                new ItemTypes(EItemType.HELD, EEquipmentType.MACE, EItemEquipSlot.ONE_HAND, EItemWeightClass.HEAVY, EWeaponDamageType.BLUNT, EWeaponRange.MEDIUM, EItemRarity.COMMON)
            ) },
        { EEquipmentType.DAGGER, new Item(
                "Dagger", "A small nimble blade with many uses", "Axe",
                new ItemStats(1, 0, 2, 1, 0, 5, 1, 10, 5, 5),
                new ItemTypes(EItemType.HELD, EEquipmentType.DAGGER, EItemEquipSlot.ONE_HAND, EItemWeightClass.VERY_LIGHT, EWeaponDamageType.SLASHING, EWeaponRange.CLOSE, EItemRarity.COMMON)
            ) },
        { EEquipmentType.ARMING_SWORD, new Item(
                ...
                new ItemTypes(EItemType.HELD, EEquipmentType.ARMING_SWORD, EItemEquipSlot.ONE_HAND, EItemWeightClass.MEDIUM, EWeaponDamageType.SLASHING, EWeaponRange.MEDIUM, EItemRarity.COMMON)
            ) },
        { EEquipmentType.LONG_SWORD, new Item(
                ...
                new ItemTypes(EItemType.HELD, EEquipmentType.LONG_SWORD, EItemEquipSlot.TWO_HAND, EItemWeightClass.HEAVY, EWeaponDamageType.SLASHING, EWeaponRange.REACH, EItemRarity.COMMON)
            ) },
        { EEquipmentType.GREAT_SWORD, new Item(
                ...
                new ItemTypes(EItemType.HELD, EEquipmentType.GREAT_SWORD, EItemEquipSlot.TWO_HAND, EItemWeightClass.VERY_HEAVY, EWeaponDamageType.SLASHING, EWeaponRange.LONG_REACH, EItemRarity.COMMON)
            ) },
        { EEquipmentType.RAPIER, new Item(
                ...
                new ItemTypes(EItemType.HELD, EEquipmentType.RAPIER, EItemEquipSlot.ONE_HAND, EItemWeightClass.MEDIUM, EWeaponDamageType.PIERCING, EWeaponRange.REACH, EItemRarity.COMMON)
            ) },
        { EEquipmentType.SHORT_BOW, new Item(
                "Short Bow", "A standard bow. Keep your distance", "Short_Bow",
                new ItemStats(2, 0, 3, 2, 0, 4, 2, 10, 5, 5),
                new ItemTypes(EItemType.HELD, EEquipmentType.SHORT_BOW, EItemEquipSlot.TWO_HAND, EItemWeightClass.MEDIUM, EWeaponDamageType.PIERCING, EWeaponRange.RANGED, EItemRarity.COMMON)
            ) },
        { EEquipmentType.LONG_BOW, new Item(
                "Long Bow", "A larger bow meant to hit enemies far away, rather than acros the room", "Long_Bow",
                new ItemStats(3, 0, 4, 3, 0, 1, 3, 10, 5, 5),
                new ItemTypes(EItemType.HELD, EEquipmentType.LONG_BOW, EItemEquipSlot.TWO_HAND, EItemWeightClass.HEAVY, EWeaponDamageType.PIERCING, EWeaponRange.RANGED, EItemRarity.COMMON)
            ) },
        { EEquipmentType.CROSSBOW, new Item(
                ...
                new ItemTypes(EItemType.HELD, EEquipmentType.CROSSBOW, EItemEquipSlot.TWO_HAND, EItemWeightClass.HEAVY, EWeaponDamageType.PIERCING, EWeaponRange.RANGED, EItemRarity.COMMON)
            ) },
        { EEquipmentType.SHIELD, new Item(
                "Shield", "Will protect you from physical attacks but not emotional attacks", "Shield",
                new ItemStats(3, 3, 0, 0, 0, 0, 3, 10, 5, 5),
                new ItemTypes(EItemType.HELD, EEquipmentType.SHIELD, EItemEquipSlot.SHIELD, EItemWeightClass.HEAVY, EWeaponDamageType.NONE, EWeaponRange.NONE, EItemRarity.COMMON)
            ) },
        ...
        { EEquipmentType.HELMET, new Item(
                "Helmet", "Will not save you from concussions", "Helmet",
                new ItemStats(2, 3, 0, 0, 0, 0, 2, 10, 5, 5),
                new ItemTypes(EItemType.ARMOR, EEquipmentType.HELMET, EItemEquipSlot.HELMET, EItemWeightClass.MEDIUM, EWeaponDamageType.NONE, EWeaponRange.NONE, EItemRarity.COMMON)
            ) },
